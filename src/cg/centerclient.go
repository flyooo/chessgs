...
func (client *CenterServer) RemovePlayer(name string) error {
...
func (client *CenterServer) ListPlayer(params string) (ps []*Player, err error) {
...
func (client *CenterServer) Broadcast(message string) error {
